    ...
    marker.setStyle(
        new Style({
          image: new Icon({
            ...
            anchorYUnits: 'pixels',
            src: 'https://i.ibb.co.com/2g25Gxq/bluemarker.png',
            scale: 0.05 
          }),
        })
      );
...
function createMarkerElement() {
  ...
  element.innerHTML = '<img src="https://i.ibb.co.com/2g25Gxq/bluemarker.png" alt="Marker" style="width: 20px; height: 20px;">';
  return element;
}
